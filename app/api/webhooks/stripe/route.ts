...
<div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;border:1px solid #E4DCFF;overflow:hidden;">
  ...
  <div style="padding:36px 40px;">
    ...
    <div style="background:#F0EBFF;border-radius:12px;padding:20px 24px;margin:24px 0 0;">
      ...
      <p style="color:#1A1027;font-size:14px;margin:0;">Reply to this email or reach us at <a href="mailto:hello@timebookingpro.com" style="color:#7C3AED;">hello@timebookingpro.com</a>. We're a small team and we read everything.</p>
    </div>
  </div>
